...
},{"./lib/chai":"22ah"}],"OXNX":[function(require,module,exports) {
var define;
"use strict";
...
exports.default = _default;
      ...
      if (typeof $52c52e === 'function') {
        ...
        Object.assign($52c52e, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"g-button",class:("icon-" + _vm.iconPosition),on:{"click":function($event){_vm.$emit('click')}}},[(_vm.icon && !_vm.loading)?_c('g-icon',{attrs:{"icon":_vm.icon}}):_vm._e(),_vm._v(" "),(_vm.loading)?_c('g-icon',{staticClass:"loading",attrs:{"icon":"icon-loading"}}):_vm._e(),_vm._v(" "),_c('div',{staticClass:"content"},[_vm._t("default")],2)],1)}
var staticRenderFns = []
...
describe('Button', function () {
  ...
  it('点击 button 触发 click 事件', function () {
    ...
    vm.$el.click();
    expect(callback).to.have.been.called; // const spy = chai.spy(() => {})
    // vm.$on("click",spy);
    // vm.$el.click()
    // expect(spy).to.have.been.called()
  });
});
},{"chai":"Pqx3","sinon-chai":"OXNX","vue":"ApMz","../src/button":"qcet"}]},{},["OGAT"], null)
